...
if __name__ == "__main__":
    ...
    # "predict"             single image predict
    # "dir_predict"         directory image predict
    # "video"               video predict
    # "fps"                 video fps and image fps, see def fps
    # "export_onnx"         将模型导出为onnx，需要pytorch1.7.1以上
    # IMPORTANT! NEED TO MODIFY HERE!
    mode = "dir_predict"

    # count, name_classes only need for mode = "predict"
    ...
    # test_interval, fps_image_path仅在mode='fps'有效
    # test_interval       用于指定测量fps的时候，图片检测的次数。理论上test_interval越大，fps越准确。
    # fps_image_path      用于指定测试的fps图片
    test_interval = 100
    fps_image_path = "img/RM0008156.jpg"

    # dir_origin_path, dir_save_path仅在mode='dir_predict'时有效
    # dir_origin_path     the directory path of images need to be predicted
    # dir_save_path       path of prediction result
    dir_origin_path = "img/"
