...
-   原始训练集下载链接: [Download Link](https://zenodo.org/record/4448186)
-   为了扩展训练集，提高数值, 我还用 [labelme](https://anaconda.org/conda-forge/labelme) 和 [labelimg](https://anaconda.org/conda-forge/labelimg) 手动新增了 200 张 Wyoming University 的 dataset.

    本项目默认训练集下载链接: [Download](https://github.com/lyzsk/support-repo)
